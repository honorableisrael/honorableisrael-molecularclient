          ...
          <Row>
            <Col md={12}>
              ...
              <div className='main_wrap_ws'>
                ...
                <p className='Construction12'>{description ?? "n/a"}</p>
              </div>
              <div className='main_wrap_ws'>
                <h6 className='userprofile12 userprofile123'>
                  Project Purpose
              ...
              <div className='main_wrap_ws main_wrap_ws22'>
                ...
                <div className=''>
                  <h6 className='userprofile12 userprofile123'>Terrain</h6>
                  <div className='Construction12'>{terrain ?? "n/a"}</div>
                </div>
              </div>
              ...
              {spread_requests.length > 0 && (
                <h6 className='userprofile12 userprofile123 userprofile1231'>
                  Spread Request
                </h6>
              )}
              {spread_requests?.map((data, i) => (
