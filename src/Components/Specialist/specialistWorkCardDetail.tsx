      ...
      <Container fluid={true}>
        <Modal
          ...
          <div className='terminateworkmodalwrap'>
            ...
            <div className='terminateworkmodaltitle'>Work Sheet Details</div>
            {successMessage && (
            ...
            <form>
              <Row>
                <Col md={12} className='formsection1'>
                  <Form.Group>
                    <h6 className='userprofile userprofile12'>Spread Name</h6>
                    <Form.Control
                      type='text'
                      name='spread_name'
                      value={
                        work_group == null ? "Not grouped" : work_group.name
                      }
                      className='userfield'
                      onChange={onchange}
                    />
              ...
              <p>
                <span className='modalupldwrksheetbtn' onClick={handleClick}>
                  Upload Work Sheet:{" "}
                </span>{" "}
                {filename}{" "}
              </p>
                ...
                <div className='job23_1a'>
                  <div className='job23_1a wrap_z'>
                    <div className='group_flex'>
                      <div className='grpA'>
                        {work_group == null && <div>Not Grouped</div>}
                        {work_group && <div>{work_group.name}</div>}
                      </div>
                      <div className='grpB'>
                        {work_group == null && <div>0 Assigned</div>}
                        {work_group && (
                          <div>
                            {" "}
