...
const Privacy = (props) => {
  ...
  return (
    <>
      <NavBar />
      <div className="container privacycont">
        <div className="terms-privacy">
          <div className="terms_item">
            ...
            <p>
              ...
              (the “Site”) and our mobile applications (collectively the “Apps”
              and each an “App”) (collectively the “Services”).
              <br />
              <p>
                These Terms incorporate by reference our privacy policies, which
                you may find when you visit the Site or when you access our App.
              </p>
              <p>
                {" "}
                ...
                allow Specialists to register or post information regarding
                their services they offer to Companies which includes but not
                limited to pipeline welding, fitting, horizontal directional
                drillings and other related technical services in the natural
                gas industry whereby Companies and Specialist are collectively,
                “Organizations.”{" "}
              </p>{" "}
              <p>
                {" "}
                By accessing or using our Services, you thereby agree that you
                have read, understood, and agree or consent to be bound by these
                Terms and our privacy policies. If you do not agree with or
                consent to being bound any of the Terms or privacy policies, you
                are not authorized to use our Services.
              </p>
            </p>
            <p>
              <b> NOTE </b> THAT THESE TERMS CONTAINS A MANDATORY ARBITRATION
              PROVISION THAT REQUIRES THE USE OF ARBITRATION ON AN INDIVIDUAL
              BASIS AND LIMITS THE REMEDIES AVAILABLE TO YOU IN THE EVENT OF
              CERTAIN DISPUTES.
            </p>
            <h5> Summary of Material Terms</h5>
            <p>
              As provided in greater detail in these Terms (and without limiting
              ...
              <p>
                {" "}
                • the use of the Services may be subject to separate third-party
                terms of service and fees, including, without limitation, terms
                of service and fees from your mobile network operator
                (“Carrier”), including fees charged for data usage and overage,
              ...
              <p>
                ...
                kind and our liability to you is limited;{" "}
              </p>
              <p>
                • disputes arising under these Terms will be resolved by binding
                arbitration, as described below; and{" "}
              </p>{" "}
              <p>
                {" "}
                • if you are using any App on an iOS-based device, you agree to
            ...
            <p>
              ...
              support services with respect to any App. In the event of any
              failure of any App to conform to any applicable warranty, then you
              may notify Apple and request that Apple refund the purchase price
              for the relevant App to you; and, to the maximum extent permitted
              by applicable law, Apple has no other warranty obligation
              whatsoever with respect to any App. Apple is not responsible for
              addressing any claims by you or any third party relating to any
              App or your possession and/or use of any App, including, but not
              limited to: (i) product liability claims; (ii) any claim that any
              ...
              <p>
                ...
                settlement, and discharge of any third party claim that any App
                or your possession and use of any App infringes that third
                party’s intellectual property rights. You will comply with any
                applicable third party terms, when using any App. Apple, and
                Apple’s subsidiaries, are third-party beneficiaries of this
                section of these Terms, and upon your acceptance of these Terms,
              </p>{" "}
              <p>
                {" "}
                Apple will have the right (and will be deemed to have accepted
                the right) to enforce this section of these Terms against you as
                a third-party beneficiary of these Terms.
              </p>
              <p> You hereby represent and warrant that</p>
              <br /> (a) you are not located in a country that is subject to a
            ...
            <p>
              ...
              Google has no obligation whatsoever to furnish any maintenance and
              support services with respect to any App. In the event of any
              failure of any App to conform to any applicable warranty, then you
              may notify Apple and request that Apple refund the purchase price
              for the relevant App to you; and, to the maximum extent permitted
              by applicable law, Google has no other warranty obligation
              whatsoever with respect to any App.
              <br />
              Google is not responsible for addressing any claims by you or any
              third party relating to any App or your possession and/or use of
              any App, including, but not limited to: <br /> (i) product
              liability claims; <br /> (ii) any claim that any App fails to
              conform to any applicable legal or regulatory requirement; and{" "}
              <br /> (iii) claims arising under consumer protection or similar
              legislation. Google is not responsible for the investigation,
              defense, settlement, and discharge of any third party claim that
              any App or your possession and use of any App infringes that third
              party’s intellectual property rights. You will comply with any
              applicable third party terms, when using any App. Google, and
              Google’s subsidiaries, are third-party beneficiaries of this
              section of these Terms, and upon your acceptance of these Terms,
              Google will have the right (and will be deemed to have accepted
              the right) to enforce this section of these Terms against you as a
              third-party beneficiary of these Terms.
              <br /> You hereby represent and warrant that <br /> (a) you are
              not located in a country that is subject to a Nigeria Government
            ...
            <h5>4. Third Party Software</h5>
            <p>
              The software you download in connection with any App consists of a
              package of components, including certain third party software
              provided under separate license terms. Your use of the third-party
              software in conjunction with the App in a manner consistent with
              the terms of these Terms is permitted, however, you may have
              broader rights under the applicable third-party terms and nothing
              in these Terms is intended to impose further restrictions on your
              use of the third-party software.
            </p>
            <h5>Target Audience</h5>
            <p>
              The Services are not targeted toward, marketed to, or intended for
              use by anyone under the age of 18. We encourage parents to
              supervise their children’s digital activities and to consider
              using parental control tools available from online services and
              software manufacturers that help provide a child-friendly online
              environment. These tools can also keep children from disclosing
              online their name, address and other personal information without
              parental consent. If you are using the Services on behalf of any
              person, you represent and warrant that you are authorized to
              accept these Terms on such person’s behalf and that such person
              agrees to be responsible to us if you or such person violates
              these Terms.
            </p>
            <h5>6. Accounts and Account Security</h5>
            <p>
              <h6> a. Eligibility </h6>You must be at least 18 years of age to
              use our Services. By agreeing to these Terms, you represent and
              warrant to us that: (a) you are at least 18 years of age; (b) you
              have not previously been suspended or removed from the Services;
              and (c) your registration and your use of the Services complies
              with all applicable laws and regulations. If you are using the
              Services on behalf of an entity, organization, or company, you
              represent and warrant that you have the authority to bind that
              entity, organization, or company to these Terms and that you agree
              on behalf of that entity, organization, or company to be bound by
              these Terms.
              <h6>b. Registration</h6> Anyone, Specialist or Organisation who is
              otherwise eligible to use the Services in accordance with these
              Terms must create an account (“Account”). Each Organization will
              designate an administrator for that Organization’s Account (the
              “Administrator”). Each Administrator may authorize other
              individuals from the same Organization to create an Account
              associated with that Organization (those authorized individuals,
              “Authorized Users”). Organizations, Administrators, and Authorized
              Users are, collectively, “Registered Users” and Registered Users
              and non-Registered Users are, collectively, “Users.”{" "}
              <h6> c. Account Security </h6>
              ...
              third party. As you will be responsible for all activity that
              occurs under your access credentials, you will use reasonable
              efforts to prevent unauthorized access to or use of the Services
              and to preserve the confidentiality of your username and password,
              and any device that you use to access the Services. You are solely
            ...
            <p>
              The materials provided, contained in or made available for use in
              connection with the Services (collectively, the “Materials”) are
              ...
              their contents are illegal is prohibited. Those who choose and
              access any of the Services from other locations do so on their own
              ...
              <br /> You are hereby granted a personal, non-exclusive,
              non-transferable, limited license to use the Services in
              accordance with these Terms. You are not allowed to modify, copy,
              distribute, transmit, display, perform, reproduce, publish,
              license, create derivative works from, transfer or sell any
              information obtained directly from the Services (including the
              Materials). Further, you may not reproduce any part of the
            ...
            <p>
              As a specific condition of your use of any of the Services, you
              explicitly agree not to (a) use any of the Services for any
              purpose that is unlawful or prohibited by these Terms; (b)
              intentionally submit or transmit inaccurate information through
              the Services; (c) impersonate or pretend to be anyone else while
              ...
              means not intentionally made available through any of the
              Services; (h) attempt to circumvent any content-filtering
              techniques we employ or attempt to access any feature or area of
              our Services that you are not authorized to access; (i) introduce
              any malicious or technologically harmful material into our
              Services; (j) develop or use any third-party applications that
              interact with our Services without our prior written consent,
              including any scripts designed to scrape or extract data from our
              Services; and (k) use our Services for any illegal or unauthorized
            ...
            <p>
              <h6> a. Buyers — Your Content</h6> If you are using the Services
              ...
              on or through the Services. <h6>b. Specialists — Your Content</h6>{" "}
              If you are a Registered User using our Services on behalf of a
              Worker, you may be able to Submit content, such as information
              regarding your business (including, but not limited to,
              certificates of insurance, Occupational, Safety And Health
              (“OSHA”) compliance information, EMR documentation, W-9s, and
              ...
              Messages has been disclosed beyond the parties to the Messages.
              <h6> d. Content Generally</h6>
              Specialist Content and Company Content are collectively referred
              to as “User Content.”{" "}
              <h6>
                {" "}
              ...
              that you Submit to the Services (“Your Content”) in order to
              facilitate the display and use of Your Content in accordance with
              the applicable settings specified in your Account and the features
              ...
              portions of the Services you utilize unless you tell us to.
              <h6> f. Limited License Grant to Other Users </h6> By posting or
              sharing User Content with other Users of the Services, you grant
              those Users a non-exclusive license to share that User Content
              with their employees, agents, representatives, and advisors, and
              to access and use that User Content as permitted by these Terms
              and the functionality of the Services.{" "}
              <h6> g. Content Disclaimer </h6> You understand that by using the
              Services, you may encounter data, information, applications,
            ...
            <h5>12. Copyright Complaints</h5>
            <p>
              The Copyright Act, Cap 28, Laws of the Federation of Nigeria 2004
              ...
              <p>
                ...
                act on behalf of the owner of the works that have been allegedly
                infringed;{" "}
              </p>
              <p>
                {" "}
            ...
            <p>
              THE SERVICES AND ALL CONTENT THEREIN ARE PROVIDED ON AN “AS
              AVAILABLE” AND “AS IS” BASIS, WITHOUT WARRANTIES OF ANY KIND,
              EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, THE
              IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
              PURPOSE, TITLE AND NON-INFRINGEMENT. WE DO NOT REPRESENT OR
              WARRANT THAT: (A) THE SERVICES AND MATERIALS ARE FREE OF ERRORS;
              (B) DEFECTS WILL BE CORRECTED; (C) THE SERVICES OR OUR SERVERS ARE
              FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS; OR (D) INFORMATION
              COMMUNICATED THROUGH THE SERVICES ARE ACCURATE, COMPLETE, OR
              USEFUL. YOU ACKNOWLEDGE AND AGREE THAT YOUR ACCESS TO, RELIANCE
              ON, AND USE OF THE SERVICES OR ANY CONTENT THEREIN IS AT YOUR OWN
              RISK. YOU WILL BE SOLELY RESPONSIBLE FOR ANY DAMAGE TO YOUR DEVICE
              OR LOSS OF DATA THAT RESULTS FROM THE DOWNLOAD OF SUCH CONTENT,
              MATERIAL AND/OR DATA. WITHOUT LIMITING THE FOREGOING, WE MAKES NO
              REPRESENTATION OR WARRANTY AS TO THE QUALITY, RELIABILITY,
              COMPLETENESS, ACCURACY, TIMELINESS, AVAILABILITY, SECURITY OR
              FUNCTIONALITY OF THE SERVICES OR ANY CONTENT THEREON. WE WILL NOT
              BE LIABLE FOR ANY HARM TO YOUR COMPUTER SYSTEM OR MOBILE DEVICE,
              OR LOSS OF DATA, THAT RESULTS FROM YOUR ACCESS TO OR USE OF THE
              SERVICES OR ANY CONTENT, OR FOR THE DELETION OF, OR THE FAILURE TO
              STORE. MOLECULAR TECHNICAL SERVICES LIMITED (“MTSL”) MAKES NO
              WARRANTY THAT THE SERVICES WILL MEET YOUR REQUIREMENTS OR BE
              AVAILABLE ON AN UNINTERRUPTED, SECURE, OR ERROR-FREE BASIS OR THAT
              DEFECTS IN THE SERVICES WILL BE CORRECTED. THE SERVICES MAY NOT BE
              CONTINUOUSLY AVAILABLE DUE TO MAINTENANCE OR REPAIRS OR DUE TO
              COMPUTER PROBLEMS OR CRASHES, DISRUPTION IN INTERNET SERVICE OR
              OTHER UNFORESEEN CIRCUMSTANCES. THE SERVICES AND ASSOCIATED
              CONTENT ARE INTENDED FOR USE AND DISPLAY ONLY WHERE ITS USE AND
              DISPLAY ARE PERMISSIBLE IN ACCORDANCE WITH APPLICABLE LAWS AND
              REGULATIONS. SOME JURISDICTIONS DO NOT ALLOW THE DISCLAIMER OF
              IMPLIED TERMS IN CONTRACTS WITH CONSUMERS, SO SOME OR ALL OF THE
              DISCLAIMERS IN THIS SECTION MAY NOT APPLY TO YOU. MOLECULAR
              TECHNICAL SERVICES LIMITED (“MTSL”) DISCLAIMS ANY AND ALL
              ...
              TO (A) ANY ERRORS IN OR OMISSIONS ON OR FROM ANY OF THE SERVICES
              AND CONTENT THEREIN, INCLUDING BUT NOT LIMITED TO TECHNICAL
              INACCURACIES AND TYPOGRAPHICAL ERRORS, (B) ANY THIRD-PARTY CONTENT
              THEREIN DIRECTLY OR INDIRECTLY ACCESSED THROUGH LINKS IN THE SITES
              OR MATERIALS PROVIDED, INCLUDING BUT NOT LIMITED TO ANY ERRORS IN
              OR OMISSIONS CONTAINED THEREIN, (C) THE UNAVAILABILITY OF ANY OF
              THE SERVICES OR ANY PORTION THEREOF, (D) YOUR USE OF ANY OF THE
              SERVICES, OR (E) YOUR USE OF ANY EQUIPMENT OR SOFTWARE IN
              CONNECTION WITH ANY OF THE SERVICES. ANY DEALINGS WITH ANY THIRD
              PARTIES (INCLUDING ADVERTISERS AND/OR SPONSORS) APPEARING ON THE
              SITES OR MATERIALS PROVIDED OR MADE AVAILABLE IN CONNECTION WITH
              PARTICIPATION IN ANY OFFERINGS AND ANY OTHER TERMS, CONDITIONS,
              WARRANTIES OR REPRESENTATIONS ASSOCIATED WITH SUCH ACTIVITIES ARE
              SOLELY BETWEEN YOU AND SUCH ADVERTISER OR OTHER THIRD PARTIES. WE
              ...
              OR THE CONTENT OF THEIR WEBSITES. MOLECULAR TECHNICAL SERVICES
              LIMITED (“MTSL”) DOES NOT ASSUME ANY RESPONSIBILITY OR LIABILITY
              FOR THE ACTIONS AND CONTENT OF ALL THESE AND ANY OTHER THIRD
              PARTIES. YOU SHOULD CAREFULLY REVIEW THEIR PRIVACY STATEMENTS OR
              POLICIES AND OTHER TERMS OR CONDITIONS OF USE OR SERVICE.
              MOLECULAR TECHNICAL SERVICES LIMITED (“MTSL”) IS NOT RESPONSIBLE
              OR LIABLE TO ANY PARTY WHO PARTICIPATES IN ANY SUCH DEALINGS. WE
              ATTEMPT TO DISPLAY THE MATERIALS AND INFORMATION YOU VIEW ON THE
              SERVICES AS ACCURATELY AS POSSIBLE. WE DO NOT GUARANTEE THE
              ACCURACY OF SUCH MATERIALS AND INFORMATION.
            </p>
            <h5>14. Limitation of Liability</h5>
            <p>
              IN NO EVENT WILL WE OR OUR DIRECTORS, OFFICERS, EMPLOYEES,
              AFFILIATES, SUBSIDIARIES, PARENT COMPANIES, MEMBERS, SHAREHOLDERS,
              AGENTS OR OTHER REPRESENTATIVES BE LIABLE FOR ANY DIRECT,
              INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES,
              OR ANY OTHER DAMAGES OF ANY KIND, ARISING OUT OF OR RELATED TO THE
              SERVICES. OUR TOTAL LIABILITY, WHETHER IN CONTRACT, WARRANTY, TORT
              (INCLUDING NEGLIGENCE) OR OTHERWISE, EVEN IF FORSEEABLE, WILL NOT
              EXCEED THE GREATER OF (I) THE TOTAL AMOUNT YOU SPENT ON YOUR
              BUSINESS DEALINGS WITH US DURING THE MOST RECENT TWELVE-MONTH
              PERIOD, OR (II) IF YOU HAVE NOT PAID US, THE AMOUNT OF $100. THESE
              EXCLUSIONS AND LIMITATIONS OF LIABILITY WILL APPLY TO THE FULLEST
              EXTENT PERMITTED BY LAW AND WILL SURVIVE CANCELLATION OR
              TERMINATION OF YOUR ACCOUNT. CERTAIN APPLICABLE LAWS MAY NOT ALLOW
              THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS
              APPLY TO YOU, SOME OR ALL OF THE ABOVE EXCLUSIONS OR LIMITATIONS
              MAY NOT APPLY TO YOU, AND YOU MIGHT HAVE ADDITIONAL RIGHTS.
            </p>
            <h5>15. Disputes with Third Parties</h5>
            <p>
              MOLECULAR TECHNICAL SERVICES LIMITED (“MTSL”) IS NOT AFFILIATED
              WITH ANY NON-EMPLOYEE WORKER, BUYER, OR THIRD PARTY SERVICE, AND
              ANY DISPUTE YOU HAVE WITH ANY NON-EMPLOYEE WORKER, BUYER,
              ...
              AND THAT THIRD PARTY, AND YOU IRREVOCABLY RELEASE MOLECULAR
              TECHNICAL SERVICES LIMITED (“MTSL”) FROM ANY AND ALL CLAIMS,
              ...
              WITH THOSE DISPUTES. YOU WILL TAKE REASONABLE PRECAUTIONS IN ALL
              INTERACTIONS WITH OTHER USERS, PARTICULARLY IF YOU MEET OFFLINE OR
              IN PERSON. YOU ASSUME ALL RISK WHEN ENGAGING THE SERVICES OF ANY
              OTHER USER AND IN CONNECTION WITH USING THE SERVICE, INCLUDING BUT
              NOT LIMITED TO ANY RISKS ASSOCIATED WITH SHARING CONFIDENTIAL
              INFORMATION WITH ANY OTHER USER. SHOULD YOU PERFORM WORK AS AN
              INDEPENDENT CONTRACTOR FACILITATED BY MOLECULAR TECHNICAL SERVICES
              LIMITED (“MTSL”) FOR A THIRD PARTY, YOU ACKNOWLEDGE THAT THE THIRD
              PARTY FOR WHOM YOU PERFORM SUCH WORK IS THE PARTY ULTIMATELY
              RESPONSIBLE FOR PAYING YOU FOR THAT WORK. SHOULD MOLECULAR
              TECHNICAL SERVICES LIMITED (“MTSL”) NOT RECEIVE PAYMENT FROM THE
              THIRD PARTY, MOLECULAR TECHNICAL SERVICES LIMITED (“MTSL”)
              RESERVES THE RIGHT TO REQUIRE YOU TO SEEK ANY REIMBURSEMENT FOR
              YOUR WORK DIRECTLY FROM THE THIRD PARTY. IN SUCH INSTANCE, YOU
              AGREE TO HOLD MOLECULAR TECHNICAL SERVICES LIMITED (“MTSL”)
              HARMLESS AND RELEASE MOLECULAR TECHNICAL SERVICES LIMITED (“MTSL”)
              FROM ANY ASSOCIATED CLAIMS.
            </p>
            <h5>16. Dispute Resolution; Binding Arbitration</h5>
            <p>
              PLEASE READ THE FOLLOWING SECTION CAREFULLY BECAUSE IT REQUIRES
              YOU TO ARBITRATE CERTAIN DISPUTES AND CLAIMS WITH MOLECULAR
              TECHNICAL SERVICES LIMITED (“MTSL”) AND LIMITS THE MANNER IN WHICH
              YOU CAN SEEK RELIEF FROM US. a. General Access to and use of any
              ...
              from other locations are solely responsible for compliance with
              their local laws. Except for any disputes, claims, suits, actions,
              causes of action, demands, or proceedings (collectively,
              “Disputes”) arising out of or related to a violation these Terms
              ...
              will be resolved by binding arbitration administered by one
              arbitrator through the American Arbitration Association. This
              agreement to arbitrate shall extend to any entity you sue
              concerning a Work Dispute and allege is your employer, jointly or
              otherwise. Such entity is likewise an intended third party
              beneficiary of this Dispute Resolution and Arbitration Section.
              This agreement to arbitrate disputes includes all claims arising
              ...
              SERVICES LIMITED (“MTSL”) ARE EACH WAIVING THE RIGHT TO A COURT
              TRIAL OR TO PARTICIPATE IN A CLASS ACTION. YOU AGREE THAT YOU MAY
              BRING CLAIMS AGAINST MOLECULAR TECHNICAL SERVICES LIMITED (“MTSL”)
              OR ITS CUSTOMERS AND OTHER THIRD PARTY BENEFICIARIES OF THIS
              AGREEMENT ONLY IN YOUR INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF
              ...
              arbitrator(s) have no authority to award punitive damages, and
              each party hereby waives any right to seek or recover punitive
              damages with respect to any dispute resolved by arbitration
              (“Punitive Damages Clause”), except where an applicable statute
              allows for punitive damages. If the Punitive Damages Clause of
              ...
              date of the termination. Termination is also not effective until
              ten (10) days after reasonable notice is given to the claimant. b.
              Exceptions Nothing in these Terms, including the provisions of
              Section 16(a), will be deemed to waive, preclude, or otherwise
              ...
              Conducted in English Language in accordance with Lagos Multi Door
              Courthouse Rules. ANY SUCH DISPUTE SHALL BE ARBITRATED ON AN
              INDIVIDUAL BASIS, AND SHALL NOT BE CONSOLIDATED IN ANY ARBITRATION
              WITH ANY DISPUTE OF ANY OTHER PARTY. d. Notice; Process A party
              ...
              place in Lagos, Nigeria, but if the claim is for $10,000 or less,
              you may choose whether the arbitration will be conducted: (i)
              solely on the basis of documents submitted to the arbitrator; (ii)
              through a non-appearance based telephone hearing; or (iii) by an
              in-person hearing as established by the ACA Rules in Nigeria. If
              ...
              setting forth the findings of fact, conclusions of law, and the
              reasons supporting the arbitrator’s decision; that the Appealable
              Award may be overturned upon de novo review of legal errors and
              for clear errors of fact; and that the Appealable Award shall not
              be considered a final award until after the time for filing the
              notice of appeal pursuant to the Appellate Rules has expired.
              Appeals must be initiated within thirty (30) days of receipt of
              the Appealable Award, as defined by ACA or Lagos Multi Door
              Courthouse Rules, by filing a Notice of Appeal and notifying the
              other party in writing. Following the appeal process, the decision
              rendered by the ACA or Lagos Multi Door Courthouse appellate
            ...
            <p>
              ...
              request, before contractual payment due date. All early payment
              request shall not exceed 65% of the actual amount of work done by
              the Specialists. All early payment shall attract a fee of 5% of
              the request amount paid.{" "}
            </p>
            ...
            <p>
              ...
              of this binding arbitration agreement. If any portion of this
              Dsipute Resolution and Binding Arbitration Section is found to be
              unenforceable, then that portion of this Dispute Resolution and
              Binding Arbitration Section will be null and void, the remaining
              provisions of these Terms will remain in effect, and the exclusive
              jurisdiction and venue described in these Terms will govern any
              action arising out of or related to these Terms.
            </p>
            <h5> 17. Governing Law and Venue</h5>
            <p>
              {" "}
              ...
              Federal Republic of Nigeria. Any Dispute between the parties that
              is not subject to arbitration or cannot be heard in small claims
              court, shall be resolved in the relevant state or federal courts
            ...
            <p>
              ...
              right, without notice and in our sole discretion, to terminate
              your right to access or use the Services at any time and for any
              or no reason, and you acknowledge and agree that we shall have no
              liability or obligation to you in such event and that you will not
              be entitled to a refund of any amounts that you have already paid
              to us, to the fullest extent permitted by applicable law.{" "}
            </p>{" "}
            ...
            <h5> 21. Consent to Electronic Communication </h5>
            <p>
              {" "}
              ...
              you have not withdrawn such consent.{" "}
            </p>{" "}
            <h5> 22. General </h5>
            <p>
              {" "}
            ...
            <b>
              {" "}
              <a href="mailto:aorinde@molecularpro.co">
                aorinde@molecularpro.co
              </a>{" "}
            </b>
            <b>
              {" "}
              <a href="tel:08134045999">08134045999</a>{" "}
            </b>
          </div>
        </div>
      </div>
