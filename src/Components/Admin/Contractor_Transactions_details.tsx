...
const Contractor_Transactions_details = (props) => {
  ...
  useEffect(() => {
    getTransactions(`${API}/admin/contractors/payment-transactions?contractor=${props.match.params.id}`);
  }, []);
          ...
          <Col md={11} className='job34'>
            <div className='title_wo'>
              <div className='workorderheader wtitle2 porderheader contractor_transactions_header'>
                ...
                Contractor Transactions Details
              </div>
            </div>
...
export default Contractor_Transactions_details;
