...
const Projects = withRouter((props) => {
  ...
  const inputModalChange = (state, credential_id) => {
    ...
    console.log(credential_id)
        ...
        Axios.put(`${API}/admin/specialists/projects/${credential_id}`, data , {
  ...
  const displayProject = () => {
    ...
    Axios.post(`${API}/admin/specialists/${props.match.params.id}/projects`, data, {
      headers: { Authorization: `Bearer ${token.access_token}` },
    })
    .then((res)=>{
       console.log(res.data);
                ...
                <div className="profiexpernceheaderwrap">
                  ...
                  <div className="credentialsactions">
                    <div>
                      <img
                        src={editicon}
                        onClick={() => editProject(item.id, index,item)}
                        className="editimg"
                      />
                    </div>
                    <div
