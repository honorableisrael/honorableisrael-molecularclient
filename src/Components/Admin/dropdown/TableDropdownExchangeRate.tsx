...
const TableDropdownExchangeRate = (props) => {
  // dropdown props
  ...
  const deletePipe = (id) => {
    ...
    Swal.fire({
      ...
      icon: "warning",
      text: "This action would erase all data associated with this rate and the action cannot be undone, do you want to continue",
...
export default TableDropdownExchangeRate;
