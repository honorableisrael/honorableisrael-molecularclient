...
const TableDropdownPipes = (props) => {
  // dropdown props
  ...
  const deletePipe = (id) => {
    ...
    Swal.fire({
      ...
      icon: "warning",
      text: "This action would erase all data associated with this pipe and the action cannot be undone, do you want to continue",
      showCancelButton: true,
      confirmButtonColor: "#d33",
      cancelButtonColor: "#3085d6",
      confirmButtonText: "Yes, delete!",
      cancelButtonText: "No, keep it",
      preConfirm: () => delete_bank(id),
    })
      .then((result) => {
        if (result.isConfirmed) {
          Swal.fire("Deleted!", "pipe has been deleted.", "success");
        }
      })
      .catch((err) => {
        console.log(err);
  ...
  const delete_bank = (id) => {
    ...
    axios
      .all([
        axios.delete(`${API}/bank-accounts/${id}`, {
        ...
        <div className="reltv">
          ...
          >
            ...
            <span
              ...
              onClick={() => deletePipe(props?.company_info?.id)}
            >
              Delete
            </span>
          </div>
...
export default TableDropdownPipes;
