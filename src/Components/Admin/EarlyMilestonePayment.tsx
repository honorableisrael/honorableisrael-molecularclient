...
const EarlyMilestonePayment = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .all([
        axios.get(
          `${API}/admin/work-orders/${props?.match?.params?.id}/specialist-early-payments`,
          {
            headers: {
          ...
          <Col md={11} className='job34'>
            <div className='title_wo'>
              <div className='workorderheader workorderheader1'>
                ...
                />
                <div className='pl-2'>Early Milestone Payment Request</div>
              </div>
            </div>
            {PaymentErrorMessage && (
...
export default EarlyMilestonePayment;
